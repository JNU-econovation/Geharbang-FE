...
export interface Step4Slice {
  step4Data: Step4Data;
  setStep4Update: <K extends keyof Step4Data>(key: K, value: Updater<Step4Data[K]>) => void;
...
export interface Step5Slice {
  step5Data: Step5Data;
  setStep5Update: <K extends keyof Step5Data>(key: K, value: Step5Data[K]) => void;
}

// 모든 Slice를 합친 타입
export type AllSlices = Step1Slice & Step2Slice & Step3Slice & Step4Slice & Step5Slice;
